...
/**
 * juni 2012
 * <p>Verwaltungsklasse für die Kunden zwischen Layout und Datenbank</p>
...
public class KundenBean implements Serializable {
	...
	/**
	 * Trigger für das Anzeigen der Kundentabelle
	...
	/**
	 * Überprüft die Eingabefelder der Kundeneinträge und gibt dazugehörige Fehlermeldungen aus
	 * Wenn Einträge vorhanden sind, speichert er diese in der Datenbank
	 */
	public void erstelleKunden() {
		...
		if (kunde_kuerzel.trim().compareTo("") == 0) {
			System.err.println("Kürzel ist leer.");
